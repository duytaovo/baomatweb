	...
	<div class="container" style="margin-left: 50px;">
		...
		<form action="">
		 <div class="modal-body">
           ...
           <a href = <c:url value = "/admin-chart/top10customer?filter=tat-ca&start_day=&end_day="></c:url> >
		...
		<div class = "row">
                 <div id = "myfirstchart-column" style="margin-top: 20px;"></div>
                 <%
	                String start_day = request.getParameter("start_day");
	              	String end_day = request.getParameter("end_day");
	              	String filter = request.getParameter("filter");
	              	ChartController chartController = new ChartController();
	              	out.println(chartController.myFirstChart(start_day, end_day, "column3d", "myfirstchart-column",filter));
                 %>      
           		<div id = "myfirstchart-pie" style="margin-top: 50px;"></div>
           		<% out.println(chartController.myFirstChart(start_day, end_day, "pie3d", "myfirstchart-pie",filter)); %>
