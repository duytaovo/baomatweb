	...
	<div class="container" style="margin-left: 50px;">
		...
		<form action="">
		 <div class="modal-body">
           ...
           <a href = <c:url value = "/admin-chart/top10product?filter=tat-ca&start_day=&end_day="></c:url> >
		...
		<div class = "row">
                 <div id = "mysecondchart-column" style="margin-top: 20px;"></div>
                 <%
                 	...
                 	String start_day = request.getParameter("start_day");
              		...
              		out.println(chartController.mySecondChart(start_day, end_day, "column3d", "mysecondchart-column", filter));
                 %>
                     
           		<div id = "mysecondchart-pie" style="margin-top: 50px;"></div>
           		
            	<%
            		out.println(chartController.mySecondChart(start_day, end_day, "pie3d", "mysecondchart-pie", filter));
            	%>
        </div>
	</div>
</body>
