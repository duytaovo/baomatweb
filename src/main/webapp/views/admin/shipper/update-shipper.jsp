...
<head>
<meta charset="UTF-8">
<title>Chinh sua don vi van chuyen</title>
</head>
<body>
			...
			<form action="update" method="post" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="form-group">
						<label>ID</label> <input value="${shipper.id}" name="id" type="text"
							class="form-control" >
					</div>
					<div class="form-group">
						<label>Name</label> <input name="name" type="text"
							class="form-control" value="${shipper.name}" required>
					</div>
					<div class="form-group">
						<div class="form-group mt-3" style="font-weight: bold;">
							<label class="mr-2">Images</label> <br>
							<c:url value="/image?fname=shipper/${shipper.images}" var="imgUrl"></c:url> <img width="50px" height="50px"
								src="${imgUrl}"> <br>
